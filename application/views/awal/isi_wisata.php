 ...
 <div class="space">
  ...
  <main id="main">
    ...
    <section id="about" class="about">
      ...
      <br><br><br>
        <img src="<?php echo base_url()?>assets/foto/<?php echo $brt->foto ?>" width="40%" >
      <br>
      <br>
       <h3><?php echo $brt->nm_tempat ?></h3>
            <b>Diskripsi</b>
      <p><?php echo $brt->diskripsi ?></p>
     <a href="<?=site_url('Awal/isi_kate/'.$brt->id)?>"> <div class="btn btn-success">Read More</div></a><br>
