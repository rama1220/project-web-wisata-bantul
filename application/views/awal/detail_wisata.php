  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          <li><a class="nav-link scrollto active" href="<?=site_url('Awal')?>">Home</a></li>
        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1">
			...
			<center>
				...
				<img src="<?php echo base_url()?>assets/foto/<?php echo $Produk->foto ?>" width="70%" height="50%">
			</center> 
			<br> 

				<center><h3><?php echo $Produk->nm_tempat ?></h3></center>
		    <br>

           <h5> Harga Tiket : <?php echo $Produk->hrg_tiket?></h5>
		   <h5>  Jam : <?php echo $Produk->jam?></h5>
		   <h5>Fasilitas : <?php echo $Produk->fasilitas?></h5>
		   <h5>Titik Kordinat : <?php echo $Produk->kordinat?></h5>
		   <br>
			<h5><?php echo $Produk->isi ?></h4> 
